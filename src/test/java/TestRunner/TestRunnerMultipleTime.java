...
public class TestRunnerMultipleTime {
	@CucumberOptions(features = "C:\\Users\\oyadavx\\git\\Intel_ISVC_R4C\\Intel_ISVC_R4C\\src\\test\\java\\FeaturesWeb\\Web_StockRotation_SaveForLater.feature", 
			glue = "StepDefination", 
			tags = "@TestCaseWSRSFLNo1", 
			monochrome = true, 
			dryRun = false, 
			plugin = {
